    ...
    <main className="min-h-screen bg-white">
      <div className="relative">
        ...
        <div className="relative bg-[#d8e0a8] py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto flex items-center justify-center md:justify-end sm:justify-end space-x-6">
            {/* Left Image */}
            {/* <div className="w-1/3"> */}
            <Image
              src={leftImage}
              alt="Decorative"
              className="absolute left-0 h-full w-[100px] object-cover hidden md:block"
              style={{
                width: "auto",
              }}
            />
